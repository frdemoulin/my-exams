...
/**
 * UE14 – Chimie organique – Chapitre 2.8 – B – Alcools, thiols et amines
    ...
    "choices": [
      {
        ...
        "correct": false,
        "explanation": "Lorsque l'alcool est la fonction principale dans ce cas simple, on utilise le suffixe -ol plutôt que le préfixe hydroxy-."
      },
      {
        "content": "Éthanol.",
        "correct": false,
  ...
  },
  {
    ...
    "choices": [
      ...
      },
      {
        ...
        "correct": false,
        "explanation": "Dans ce composé monofonctionnel, l'amine est la fonction principale et s'exprime par le suffixe -amine : butan-2-amine."
      },
      {
