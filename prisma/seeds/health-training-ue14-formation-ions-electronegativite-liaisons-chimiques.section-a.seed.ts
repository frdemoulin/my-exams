...
export const SECTION_A_QUESTIONS: SeedQuestion[] = [
    ...
    },
  {
      ...
      choiceExplanations: [
        ...
        `Parmi ces trois éléments, l'ordre d'affinité électronique retenu est $\\mathrm{F} > \\mathrm{O} > \\mathrm{N}$. Le fluor ne doit gagner qu'un électron pour compléter sa couche de valence.`,
        `L'affinité électronique est plus importante pour les petits atomes, dont le noyau attire plus fortement l'électron capté. Ainsi, $\\mathrm{F} > \\mathrm{I}$.`,
