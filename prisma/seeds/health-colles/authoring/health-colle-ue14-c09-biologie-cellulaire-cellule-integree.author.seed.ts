...
export const UE14_COLLE_C09_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Concernant la mitochondrie et la respiration cellulaire ainsi que le noyau, la chromatine et le nucléole, quelles propositions sont exactes ?",
    "explanation": "À retenir : La mitochondrie possède une membrane externe et une membrane interne distinctes. La chaîne respiratoire mitochondriale est localisée dans la membrane interne.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "Quelle affirmation décrit correctement la mitochondrie et la respiration cellulaire ?",
    "explanation": "Le complexe II ne pompe pas directement de protons.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "question": "Sélectionnez exactement les deux propositions exactes concernant la mitochondrie et la respiration cellulaire.",
    "explanation": "Les deux points à retenir sont les suivants : Le complexe II de la chaîne respiratoire ne pompe pas directement de protons. Les complexes I, III et IV contribuent au pompage de protons à travers la membrane interne.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "EASY",
    "format": "QRM",
    "question": "Concernant le noyau, la chromatine et le nucléole ainsi que la mitochondrie et la respiration cellulaire, quelles propositions sont exactes ?",
    "explanation": "À retenir : L’ATP synthase exploite le gradient électrochimique de protons pour synthétiser de l’ATP. Le complexe II de la chaîne respiratoire ne pompe pas directement de protons.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "HARD",
    "format": "QRU",
    "question": "Concernant la mitochondrie et la respiration cellulaire, quelle proposition est exacte ?",
    "explanation": "Il transfère des électrons vers l’ubiquinone sans translocation protonique couplée.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "format": "QRP",
    "requiredSelectionCount": 2,
    "question": "Parmi ces cinq affirmations portant sur la mitochondrie et la respiration cellulaire, retenez exactement les deux correctes.",
    "explanation": "Les deux points à retenir sont les suivants : L’ADN mitochondrial humain est distinct de l’ADN nucléaire. L’ATP synthase exploite le gradient électrochimique de protons pour synthétiser de l’ATP.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "question": "Parmi ces dix propositions portant sur le noyau, la chromatine et le nucléole ainsi que la mitochondrie et la respiration cellulaire, sélectionnez exactement les cinq exactes.",
    "explanation": "Les cinq points à retenir sont les suivants : L’ADN mitochondrial humain est distinct de l’ADN nucléaire. Les pores nucléaires sont constitués de nucléoporines. Les lamines A/C sont codées par le gène LMNA. L’enveloppe nucléaire comporte deux membranes séparées par un espace périnucléaire. Les signaux de localisation nucléaire sont souvent riches en lysine et arginine.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "HARD",
    "format": "QRM",
    "question": "Concernant le cycle cellulaire et ses contrôles ainsi que le noyau, la chromatine et le nucléole, quelles propositions sont exactes ?",
    "explanation": "À retenir : L’enveloppe nucléaire comporte deux membranes séparées par un espace périnucléaire. Les pores nucléaires sont constitués de nucléoporines.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "Parmi ces cinq affirmations sur la mitochondrie et la respiration cellulaire, laquelle est correcte ?",
    "explanation": "La force proton-motrice couple respiration et phosphorylation.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "format": "QRP",
    "requiredSelectionCount": 2,
    "question": "Sélectionnez exactement les deux propositions exactes concernant le noyau, la chromatine et le nucléole.",
    "explanation": "Les deux points à retenir sont les suivants : L’enveloppe nucléaire comporte deux membranes séparées par un espace périnucléaire. Les pores nucléaires sont constitués de nucléoporines.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "HARD",
    "format": "QRM",
    "question": "Sur la mitochondrie et la respiration cellulaire ainsi que le noyau, la chromatine et le nucléole, quelles affirmations sont correctes ?",
    "explanation": "À retenir : Un nucléosome canonique contient un octamère d’histones avec deux copies de H2A, H2B, H3 et H4. Les lamines A/C sont codées par le gène LMNA.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "La mitochondrie et la respiration cellulaire : quelle affirmation est juste ?",
    "explanation": "Il constitue une petite fraction du génome cellulaire total.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "format": "QRP",
    "requiredSelectionCount": 2,
    "question": "Parmi ces cinq affirmations portant sur le noyau, la chromatine et le nucléole, retenez exactement les deux correctes.",
    "explanation": "Les deux points à retenir sont les suivants : Les signaux de localisation nucléaire sont souvent riches en lysine et arginine. Les lamines A/C sont codées par le gène LMNA.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "EASY",
    "format": "QRM",
    "question": "Concernant le noyau, la chromatine et le nucléole, quelles propositions sont exactes ?",
    "explanation": "À retenir : L’ARN polymérase I transcrit le précurseur 45S des ARNr 18S, 5,8S et 28S. Le nucléole n’est pas limité par une membrane. En G1, une cellule diploïde non répliquée est classiquement décrite 2n/2C.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Concernant le cycle cellulaire et ses contrôles, quelles propositions sont exactes ?",
    "explanation": "À retenir : Le complexe cycline B–CDK1 constitue le MPF classique favorisant l’entrée en mitose. Wee1 phosphoryle CDK1 sur des sites inhibiteurs alors que Cdc25 retire ces phosphates inhibiteurs. En G2, une cellule diploïde après réplication est classiquement 2n/4C.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "EASY",
    "format": "QRM",
    "question": "Concernant la mitochondrie et la respiration cellulaire ainsi que le cycle cellulaire et ses contrôles, quelles propositions sont exactes ?",
    "explanation": "À retenir : APC/C-Cdc20 favorise la dégradation de la sécurine et de la cycline B. Le point de contrôle du fuseau implique des protéines MAD/BUB et retarde l’activation d’APC/C-Cdc20 tant que des kinétochores ne sont pas correctement attachés. La cytocinèse animale implique un anneau contractile d’actine et de myosine II.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Parmi les propositions suivantes portant sur la mitochondrie et la respiration cellulaire ainsi que le noyau, la chromatine et le nucléole, lesquelles sont exactes ?",
    "explanation": "À retenir : La chaîne respiratoire mitochondriale est localisée dans la membrane interne. La mitochondrie possède une membrane externe et une membrane interne distinctes. Le complexe II de la chaîne respiratoire ne pompe pas directement de protons. Les complexes I, III et IV contribuent au pompage de protons à travers la membrane interne.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Concernant la mitochondrie et la respiration cellulaire, le noyau, la chromatine et le nucléole, ainsi que le cycle cellulaire et ses contrôles, quelles propositions sont exactes ?",
    "explanation": "À retenir : L’ADN mitochondrial humain est distinct de l’ADN nucléaire. L’ATP synthase exploite le gradient électrochimique de protons pour synthétiser de l’ATP. L’enveloppe nucléaire comporte deux membranes séparées par un espace périnucléaire. Le complexe II de la chaîne respiratoire ne pompe pas directement de protons.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
      "colle:C09",
