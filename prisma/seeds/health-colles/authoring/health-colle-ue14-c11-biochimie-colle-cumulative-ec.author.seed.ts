...
export const UE14_COLLE_C11_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  ...
  },
  {
    ...
    difficulty: 'EASY',
    format: 'QRU',
    question: "Quelle proposition décrit correctement la molécule C représentée sur le schéma ?",
    explanation: "La molécule C est un céramide : elle associe un squelette de sphingosine et un acide gras lié à la fonction amine par une liaison amide. Le céramide constitue le noyau structural de nombreux sphingolipides.",
    ...
    choices: [
      ...
      {
        content: "Elle associe une sphingosine et un acide gras lié par une liaison amide.",
        correct: true,
        explanation: "C’est la définition structurale du céramide.",
      },
      {
        content: "Elle possède obligatoirement un groupement phosphate et une choline.",
        correct: false,
        explanation: "Cette tête polaire caractérise la sphingomyéline, pas tous les céramides.",
      },
      {
        content: "Elle est constituée de cholestérol estérifié par un acide gras.",
        correct: false,
        explanation: "Cette structure correspond à un stéride.",
      },
      {
        content: "Elle est un glycosaminoglycane sulfaté de la matrice extracellulaire.",
        correct: false,
  ...
  },
  {
    ...
    format: 'QRP',
    requiredSelectionCount: 2,
    question: "En comparant S et S’, sélectionnez exactement les deux propositions correctes.",
    explanation: "S représente le cholestérol libre, qui appartient aux stérols et porte un groupement hydroxyle. Dans S’, cet hydroxyle est estérifié par un acide gras : la petite région polaire du cholestérol libre disparaît alors, ce qui augmente le caractère hydrophobe de la molécule.",
    tags: ['usage:COLLE', 'ue:UE14', 'colle:C11', 'ec:BIOCHIMIE', 'theme:sterols-steroides'],
    choices: [
      {
        content: "S possède une fonction alcool et appartient aux stérols.",
        correct: true,
        explanation: "Le suffixe stérol renvoie notamment à la présence du groupe hydroxyle.",
      },
      {
        content: "S’ est plus hydrophobe que S car l’hydroxyle libre de S a été estérifié.",
        correct: true,
        explanation: "L’estérification masque le groupe hydroxyle polaire du cholestérol.",
      },
      {
        content: "S est un triacylglycérol à trois chaînes d’acides gras.",
        correct: false,
        explanation: "Il possède un noyau stéroïdien tétracyclique.",
      },
      {
        content: "Toutes les hormones stéroïdiennes sont des protéines glycosylées dérivées de S.",
        correct: false,
        explanation: "Elles sont des dérivés lipidiques du cholestérol.",
      },
      {
        content: "S’ est obligatoirement un phospholipide membranaire.",
        correct: false,
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        correct: true,
        explanation: "Elle correspond à un logarithme de rapport d’intensités lumineuses.",
      },
      {
        content: "Beer-Lambert implique que la concentration est inversement proportionnelle à l’absorbance.",
        correct: false,
        explanation: "L’absorbance est directement proportionnelle à la concentration.",
      },
    ],
  },
  {
