...
export const UE14_COLLE_C06_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  {
    ...
    "difficulty": "HARD",
    "format": "QRM",
    "question": "Colle C06 — concernant RER, quelles propositions sont exactes ?",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Colle C06 — concernant SNARE, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "EASY",
    "format": "QRM",
    "question": "Colle C06 — concernant peroxysomes, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "Quelle proposition est exacte à propos de Golgi ?",
    "explanation": "Les cargaisons traversent des compartiments golgiens avant leur destination.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Colle C06 — concernant clathrine, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "EASY",
    "format": "QROC",
    "question": "Quel enzyme peroxysomale dégrade le peroxyde d’hydrogène ?",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Colle C06 — concernant adressage, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
