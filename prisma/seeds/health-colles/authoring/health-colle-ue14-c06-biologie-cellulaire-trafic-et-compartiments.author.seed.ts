...
export const UE14_COLLE_C06_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  ...
  },
  {
    ...
    difficulty: 'MEDIUM',
    format: 'QROC',
    question: "Quelle petite GTPase initie classiquement l’assemblage du manteau COPII sur la membrane du réticulum endoplasmique ?",
    explanation: "L’activation de Sar1 par échange GDP/GTP permet son insertion dans la membrane du réticulum endoplasmique et initie le recrutement des composants du manteau COPII.",
    tags: ['usage:COLLE', 'ue:UE14', 'colle:C06', 'ec:BIOLOGIE_CELLULAIRE', 'theme:sar1-copii'],
    answer: {
      type: 'text',
      acceptedAnswers: ['Sar1', 'SAR1', 'Sar1-GTP'],
      normalization: {
        trim: true,
        collapseWhitespace: true,
        caseSensitive: false,
  ...
  },
  {
    ...
    answer: {
      type: 'text',
      acceptedAnswers: ['SNARE', 'SNAREs', 'protéines SNARE', 'protéines SNAREs'],
      normalization: {
        trim: true,
        collapseWhitespace: true,
        caseSensitive: false,
  ...
  },
  {
    ...
    difficulty: 'EASY',
    format: 'QROC',
    question: "Quel nom porte la vésicule à double membrane qui séquestre du matériel cytoplasmique au cours de la macroautophagie ?",
    explanation: "Au cours de la macroautophagie, une membrane d’isolement s’étend autour du matériel cytoplasmique puis se ferme pour former un autophagosome à double membrane.",
    tags: ['usage:COLLE', 'ue:UE14', 'colle:C06', 'ec:BIOLOGIE_CELLULAIRE', 'theme:autophagosome'],
    answer: {
      type: 'text',
      acceptedAnswers: ['autophagosome', 'un autophagosome'],
      normalization: {
        trim: true,
        collapseWhitespace: true,
        caseSensitive: false,
