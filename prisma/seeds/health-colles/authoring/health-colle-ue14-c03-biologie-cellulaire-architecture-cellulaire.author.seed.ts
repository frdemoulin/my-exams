...
export const UE14_COLLE_C03_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  {
    ...
    "difficulty": "HARD",
    "format": "QRM",
    "question": "Colle C03 — concernant membrane, quelles propositions sont exactes ?",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "Quelle proposition est exacte à propos de membrane ?",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Colle C03 — concernant transport, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "Quelle proposition est exacte à propos de transport ?",
    "explanation": "Elle résulte du passage spontané selon le gradient pour des molécules compatibles avec le cœur hydrophobe.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "EASY",
    "format": "QRM",
    "question": "Colle C03 — concernant microtubules, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Colle C03 — concernant filaments intermediaires, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "HARD",
    "format": "QRM",
    "question": "Colle C03 — concernant moteurs, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
  ...
  },
  {
    ...
    "difficulty": "HARD",
    "format": "QRM",
    "question": "Colle C03 — concernant transfection, quelles propositions sont exactes ?",
    "explanation": "Les propositions doivent être appréciées séparément : les formulations absolues ou les confusions de concepts proches constituent ici des distracteurs volontaires.",
    "tags": [
      "usage:COLLE",
      "ue:UE14",
