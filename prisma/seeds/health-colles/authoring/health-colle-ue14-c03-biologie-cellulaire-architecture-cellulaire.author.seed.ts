...
export const UE14_COLLE_C03_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { content: "Les glycolipides et les chaînes glucidiques des glycoprotéines sont confinés au feuillet cytosolic de la membrane plasmique.", correct: false, explanation: "Les glucides membranaires sont exposés du côté extracellulaire et participent notamment au glycocalyx." },
  ...
  },
  {
    ...
    explanation: "Les microtubules sont construits à partir de tubuline $\\alpha/\\beta$ et les microfilaments à partir d’actine. Les filaments intermédiaires forment une famille distincte de polymères fibreux.",
    tags: ['usage:COLLE', 'ue:UE14', 'colle:C03', 'ec:BIOLOGIE_CELLULAIRE', 'theme:cytosquelette-composition'],
    choices: [
      { content: "Microtubule — hétérodimères de tubuline $\\alpha/\\beta$.", correct: true, explanation: "Les hétérodimères $\\alpha/\\beta$-tubuline s’assemblent en protofilaments puis en microtubules." },
      { content: "Filament intermédiaire — polymère de tubuline $\\beta$ exclusivement.", correct: false, explanation: "Les filaments intermédiaires sont constitués de protéines fibreuses variées telles que kératines, vimentine, neurofilaments ou lamines." },
  ...
  },
  {
    ...
    choices: [
      ...
      { content: "La $\\beta$-tubuline peut fixer et hydrolyser le GTP.", correct: true, explanation: "Le GTP porté par la $\\beta$-tubuline est hydrolysable et participe à la dynamique des microtubules." },
      ...
      { content: "Les microtubules cytoplasmiques sont constitués d’actine G.", correct: false, explanation: "Ils sont constitués de tubuline $\\alpha/\\beta$ ; l’actine G polymérise en microfilaments." },
  ...
  },
  {
    ...
    choices: [
      ...
      { content: "La tubuline $\\beta$.", correct: false, explanation: "La tubuline $\\beta$ entre dans la constitution des microtubules." },
  ...
  },
  {
    ...
    choices: [
      ...
      {
        content: "La $\\ce{Na+}/\\ce{K+}$-ATPase contribue indirectement à l’absorption apicale du glucose en maintenant le gradient de sodium.",
        correct: true,
        explanation: "Vrai. La $\\ce{Na+}/\\ce{K+}$-ATPase entretient le gradient de sodium indispensable au transport actif secondaire.",
      },
      {
