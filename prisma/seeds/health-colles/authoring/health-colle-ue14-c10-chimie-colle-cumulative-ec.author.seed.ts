...
Données : $M(\mathrm C)=${texQuantity(12, U.G_PER_MOL)}$, $M(\mathrm H)=${texQuantity(1, U.G_PER_MOL)}$, $M(\mathrm N)=${texQuantity(14, U.G_PER_MOL)}$ et $M(\mathrm O)=${texQuantity(16, U.G_PER_MOL)}$.`,
  ...
  },
  {
    ...
    format: 'QRPL',
    requiredSelectionCount: 5,
    question: "Parmi ces dix propositions de réactivité organique, sélectionnez exactement les cinq exactes.",
    explanation: "Il faut suivre la polarité des fonctions et la classe des réactifs : hydrures et organomagnésiens attaquent les carbones électrophiles, les amines réagissent comme nucléophiles et les dérivés d’acides subissent des substitutions nucléophiles d’acyle.",
    tags: ['usage:COLLE', 'ue:UE14', 'colle:C10', 'ec:CHIMIE', 'theme:reactivite-organique-integree'],
    choices: [
      {
        content: "Un aldéhyde réduit par NaBH4 donne typiquement un alcool primaire.",
        correct: true,
        explanation: "Le carbone carbonylé de R–CHO devient le carbone porteur de OH dans R–CH2OH.",
      },
      {
        content: "Une cétone réagissant avec un organomagnésien puis hydrolysée peut conduire à un alcool tertiaire.",
        correct: true,
        explanation: "L’addition d’un groupe carboné sur le carbonyle d’une cétone forme, après hydrolyse, un alcool tertiaire.",
      },
      {
        content: "Une amine primaire peut réagir avec un aldéhyde ou une cétone pour former une imine après élimination d’eau.",
        correct: true,
        explanation: "La condensation d’une amine primaire sur un composé carbonylé conduit à une imine.",
      },
      {
        content: "L’hydrolyse d’un thioester peut régénérer un acide carboxylique et un thiol.",
        correct: true,
        explanation: "La rupture de la liaison thioester conduit aux fonctions acide et thiol correspondantes.",
      },
      {
        content: "Un organomagnésien réagit avec CO2 puis, après hydrolyse, donne un acide carboxylique comportant un carbone supplémentaire.",
        correct: true,
        explanation: "Le carbone du CO2 devient le carbone de la fonction carboxyle.",
      },
      {
        content: "NaBH4 oxyde un alcool primaire en acide carboxylique.",
        correct: false,
        explanation: "NaBH4 est un réducteur, pas un oxydant.",
      },
      {
        content: "Une amine secondaire condensée avec un carbonyle donne nécessairement une amide sans élimination d’eau.",
        correct: false,
        explanation: "Dans le cadre étudié, une amine secondaire avec un aldéhyde ou une cétone conduit à une espèce de type iminium après condensation.",
      },
      {
        content: "L’acide carboxylique non activé est toujours plus électrophile qu’un chlorure d’acyle.",
        correct: false,
        explanation: "Le chlorure d’acyle est un dérivé activé beaucoup plus réactif vis-à-vis des nucléophiles.",
      },
      {
        content: "L’oxydation usuelle d’une cétone simple en alcool secondaire est une réduction.",
        correct: false,
        explanation: "Le passage cétone → alcool secondaire correspond à une réduction.",
      },
      {
        content: "Une saponification transforme un ester en alcène par élimination d’eau.",
        correct: false,
        explanation: "La saponification est une hydrolyse basique d’ester.",
      },
    ],
  },
  {
