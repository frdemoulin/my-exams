...
export async function seedHealthColleUE14C08(prisma: PrismaClient, programVersionSlug = "las-sps-2026-2027") {
  ...
  if (!courseUnit) throw new Error(`Impossible de trouver l'UE14 pour C08 (${programVersionSlug}).`);
