...
/**
 * UE14 – Chimie organique – Chapitre 2.8 – Section D – Acides, esters et amides
 * Ordres 67–88 (22 questions)
 * D1 — Acides carboxyliques, esters et amides — fondamentaux : ordres 67–76, DISCOVER
 * D2 — Acides carboxyliques, esters et amides — application : ordres 77–88, PRACTICE
 */
...
export const UE14_CH12_SECTION_D_V2_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  ...
  },
  {
    ...
    "explanation": "La partie acyle est éthanoate. Le groupe attaché à l'oxygène est propan-2-yle ; le nom systématique attendu est éthanoate de propan-2-yle. « Éthanoate d'isopropyle » est également reconnu ici comme appellation usuelle."
  },
  {
    "order": 83,
    "difficulty": "MEDIUM",
