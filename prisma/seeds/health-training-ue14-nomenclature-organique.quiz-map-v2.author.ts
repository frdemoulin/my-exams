...
export const UE14_CH12_V2_QUIZ_MAP = [
  ...
  },
  {
    ...
    description: `Applications de la méthode : numérotation, substituants, halogènes, insaturations et assemblage du nom.`,
  ...
  },
  {
    ...
    description: `Repères de nomenclature sur les fonctions hydroxyle, thiol et amine : suffixes, locants et substituants.`,
    stage: 'DISCOVER' as const,
  ...
  },
  {
    ...
    title: `Alcools, thiols et amines`,
    description: `Entraînement à la nomenclature systématique des alcools, thiols et amines, y compris les substitutions sur l'azote.`,
    stage: 'PRACTICE' as const,
  ...
  },
  {
    ...
    description: `Repères sur les fonctions carbonylées et nitrile : carbone fonctionnel, suffixes -al, -one et -nitrile.`,
    stage: 'DISCOVER' as const,
  ...
  },
  {
    ...
    title: `Aldéhydes, cétones et nitriles`,
    description: `Applications de la nomenclature systématique aux structures ramifiées comportant aldéhyde, cétone ou nitrile.`,
    stage: 'PRACTICE' as const,
  ...
  },
  {
    ...
    description: `Repères sur la nomenclature des acides carboxyliques, des esters et des amides.`,
    stage: 'DISCOVER' as const,
  ...
  },
  {
    ...
    title: `Acides, esters et amides`,
    description: `Entraînement au nommage des acides, esters et amides, avec ramifications et substitutions sur l'azote.`,
    stage: 'PRACTICE' as const,
  ...
  },
  {
    ...
    description: `Repères sur la priorité entre fonctions concurrentes et sur le passage du suffixe au préfixe pour les fonctions secondaires.`,
    stage: 'DISCOVER' as const,
  ...
  },
  {
    ...
    description: `Applications de nomenclature à des molécules portant plusieurs fonctions et nécessitant un choix de priorité.`,
    stage: 'PRACTICE' as const,
  ...
  },
  {
    ...
    description: `Consolidation de toutes les étapes de la nomenclature sur l'ensemble des fonctions étudiées.`,
    stage: 'PRACTICE' as const,
