...
/**
 * UE14 – Chimie organique – Chapitre 2.8 – A – La méthode : chaîne principale et numérotation
...
export const UE14_CH12_SECTION_A_V2_QUESTIONS: HealthTrainingAuthorQuestion[] = [
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRM",
    "question": "Concernant les préfixes utilisés pour certains groupes fonctionnels ou substituants, quelles associations sont exactes ?",
    "choices": [
      {
        "content": "Le groupe $\\ce{-NO2}$ est nommé par le préfixe nitro-.",
        "correct": true,
        "explanation": "Le groupe nitro est exprimé par le préfixe nitro-."
      },
      {
        "content": "F correspond à fluoro- et Cl à chloro-.",
        "correct": true,
        "explanation": "Les halogènes fluor et chlore sont nommés comme substituants par les préfixes fluoro- et chloro-."
      },
      {
        "content": "Br correspond à bromo- et I à iodo-.",
        "correct": true,
        "explanation": "Les substituants bromés et iodés utilisent respectivement les préfixes bromo- et iodo-."
      },
      {
        "content": "Un groupe $\\ce{-OR}$, avec R alkyle, peut être nommé par un préfixe alcoxy- adapté au groupe R.",
        "correct": true,
        "explanation": "Les groupes $\\ce{-OR}$ sont décrits comme alcoxy-, par exemple méthoxy- pour $\\ce{-OCH3}$."
      },
      {
        "content": "F correspond à chloro- et Cl à fluoro-.",
        "correct": false,
        "explanation": "Les deux préfixes sont inversés : F donne fluoro- et Cl donne chloro-."
      }
    ],
    "explanation": "Certains groupes sont exprimés par des préfixes : fluoro-, chloro-, bromo-, iodo-, nitro- et alcoxy-. Il faut les reconnaître avant d'assembler le nom complet."
  },
  {
    "order": 14,
    "difficulty": "MEDIUM",
  ...
  },
  {
    ...
    "difficulty": "MEDIUM",
    "format": "QRU",
    "question": "Quel est le nom systématique de $\\ce{CH3-C#C-CH3}$ ?",
    "choices": [
      {
        "content": "But-2-yne.",
        "correct": true,
        "explanation": "La chaîne comporte quatre carbones et la triple liaison commence au carbone 2 : but-2-yne."
      },
      {
        "content": "But-1-yne.",
        "correct": false,
        "explanation": "La triple liaison n'est pas terminale ; elle relie les carbones 2 et 3."
      },
      {
        "content": "Prop-1-yne.",
        "correct": false,
      ...
      },
      {
        "content": "But-2-ène.",
        "correct": false,
        "explanation": "Le suffixe -ène désigne une double liaison ; la structure possède une triple liaison."
      },
      {
        "content": "Butane.",
        "correct": false,
        "explanation": "Le suffixe -ane correspond à une chaîne saturée, ce qui n'est pas le cas ici."
      }
    ],
    "explanation": "Une triple liaison est indiquée par le suffixe -yne. Avec quatre carbones et une triple liaison commençant en C2, le nom est but-2-yne."
  },
  {
    "order": 16,
    "difficulty": "MEDIUM",
  ...
  },
  {
    ...
    "format": "QRP",
    "requiredSelectionCount": 2,
    "question": "On considère $\\ce{CH3-CH(CH3)-CH2-Br}$. Sélectionnez exactement les deux propositions incorrectes.",
    "choices": [
      {
        "content": "Le nom 3-bromo-2-méthylpropane doit être préféré car le brome est dessiné à droite.",
        "correct": true,
        "explanation": "Incorrect : l'orientation du dessin ne commande pas la numérotation ; on retient les plus petits locants."
      },
      {
        "content": "La numérotation depuis l'extrémité portant Br donne bromo en C1 et méthyle en C2.",
        "correct": false,
        "explanation": "Correct : ce sens fournit les locants 1 et 2."
      },
      {
        "content": "Le nom systématique est 1-bromo-2-méthylpropane.",
        "correct": false,
        "explanation": "Correct : le parent est propane, avec bromo en C1 et méthyle en C2."
      },
      {
        "content": "Le brome doit être exprimé par un suffixe « -brome ».",
        "correct": true,
        "explanation": "Incorrect : le brome est exprimé par le préfixe bromo-."
      },
      {
        "content": "La chaîne principale comporte trois carbones.",
        "correct": false,
        "explanation": "Correct : la plus longue chaîne carbonée continue est un propane."
      }
    ],
    "explanation": "Les halogènes sont traités comme substituants : on choisit le parent carboné, on minimise les locants puis on utilise le préfixe adapté, ici bromo-."
  },
  {
    "order": 21,
    "difficulty": "HARD",
