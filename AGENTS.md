...
- Pour toute création, modification ou intégration d'un examen blanc Santé (ex : UE14), les agents IA doivent obligatoirement se référer au document canonique de cadrage correspondant (`docs/content/health-ue14-exam-blanc-authoring.md` pour l'UE14), ainsi qu'aux règles TeX/KaTeX (`docs/cadrage-rendu-katex.md` et `docs/content/health-training-seed-authoring.md`) et de terminologie Santé (`docs/product/terminologie-entrainement-sante.md`).
