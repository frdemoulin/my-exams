...
export function HealthCourseUnitTabs({
  ...
  const isEvaluationsTabActive =
    activeTeachingElementId === 'evaluations' ||
    activeTeachingElementId === 'synthese' ||
    (activeTeachingElementId ? false : courseUnit.teachingElements.length === 0);
  ...
  return (
    <>
      <Tabs applyTheme="replace" variant="underline" theme={healthTabsTheme}>
        ...
        <TabItem
          active={isEvaluationsTabActive}
          title={
            <span className="inline-flex items-center gap-2">
              <span>Évaluations</span>
              <Badge variant="outline">Évaluations transversales</Badge>
            </span>
          }
        >
          <div className="space-y-10">
            {/* Section 1: Colles */}
            <section className="space-y-5" aria-labelledby="health-colles-heading">
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  <h2 id="health-colles-heading" className="text-xl font-semibold text-heading">
                    Colles
                  </h2>
              ...
              <div className="grid gap-3.5">
                {HEALTH_COLLES_UE14_V1.map((colle) => (
                  <HealthColleCard
                    key={colle.id}
                    colle={colle}
