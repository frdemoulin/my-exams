...
import { deleteDivision } from "@/actions/division/delete-division";
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="hover:cursor-pointer" onClick={() => handleOnClickDeleteButton(division.id)}>
              Supprimer
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
