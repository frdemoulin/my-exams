...
import { seedHealthTrainingUe14BiologieCellulairePeroxysomes } from "../../prisma/seeds/health-training-ue14-biologie-cellulaire-peroxysomes.seed";

export const description =
  "Ajoute les sections, questions et quiz du chapitre 6 de biologie cellulaire de l'UE14 Santé de Reims.";
